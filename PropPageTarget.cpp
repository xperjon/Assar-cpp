...
IMPLEMENT_DYNCREATE(CPropPage2Target, CPropertyPage)
...
// CPropPage2Target property page



CPropPage2Target::CPropPage2Target() : CPropertyPage(CPropPage2Target::IDD)

{

	//{{AFX_DATA_INIT(CPropPage2Target)
...
CPropPage2Target::~CPropPage2Target()
...
void CPropPage2Target::DoDataExchange(CDataExchange* pDX)

{

	CPropertyPage::DoDataExchange(pDX);

	//{{AFX_DATA_MAP(CPropPage2Target)
...
void CPropPage2Target::Init(CUtrustning* pUtr)
...
BOOL CPropPage2Target::OnInitDialog() 

{
	...
	test->CreateFont(72, 0, 0, 0, FW_NORMAL, 0, 0, 0, DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY, FF_DONTCARE, _T("Arial"));



	GetDlgItem(IDC_STATIC_PREVIEW)->SetFont(test,TRUE);
...
BEGIN_MESSAGE_MAP(CPropPage2Target, CPropertyPage)

	//{{AFX_MSG_MAP(CPropPage2Target)
