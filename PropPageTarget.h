...
// CPropPage2Target dialog



class CPropPage2Target : public CPropertyPage

{

	DECLARE_DYNCREATE(CPropPage2Target)
...
// Dialog Data
	...
	//{{AFX_DATA(CPropPage2Target)

	enum { IDD = IDD_PROP_SYMBOL };
